...
cp COPYING %{buildroot}/usr/share/package-licenses/perl-Canary-Stability/COPYING
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.1/Canary/Stability.pm
...
/usr/share/package-licenses/perl-Canary-Stability/COPYING
